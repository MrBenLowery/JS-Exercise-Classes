...
class Instructor extends Lambdasian {
  constructor(whatever) {
    super(whatever);
    this.specialty = whatever.specialty;
    this.favLanguage = whatever.favLanguage;
    this.catchPhrase = whatever.catchPhrase
  }
  demo(subject) {
...
class Student extends Lambdasian {
  constructor(whatever) {
    super(whatever);
    this.previousBackground = whatever.previousBackground;
    this.className = whatever.className;
    this.favSubjects = whatever.favSubjects;
  }
  listSubjects() {
...
class ProjectManager extends Instructor {
  constructor(whatever) {
    super(whatever)
    this.gradClassName = whatever.gradClassName;
    this.favInstructor = whatever.favInstructor;
  }
  standUp(channel) {
